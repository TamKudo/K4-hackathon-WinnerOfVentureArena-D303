  ...
  return (
    <div className="lf-fade-in space-y-5">
      ...
      <section className="space-y-4 rounded-xl border border-line bg-surface px-5 py-5 shadow-sm">
        ...
        {/* Từ feedback validation (spec §9): gợi ý cũ quá mờ, user không thấy. Đưa lên
            đầu khối, thêm icon và nền để nổi hơn — evidence bấm được là tính năng lõi. */}
        <p className="flex items-center gap-2 rounded-lg bg-primary-soft/50 px-3 py-2 text-base text-ink">
          <Quote aria-hidden className="h-4 w-4 shrink-0 text-primary" />
          <span>
            Bấm vào <strong className="font-semibold">phần được đánh dấu</strong> để mở đúng
            đoạn giảng gốc và tự kiểm chứng.
          </span>
        </p>
      </section>
